...
export const metadata = {
  title: "Privacy Policy | Monsta E-COM",
  description: "Read the Monsta E-COM privacy policy and learn how personal data is collected, used, retained, and protected.",
};

export default function PrivacyPolicyPage() {
  return (
    <main className="bg-white text-black">
      <Breadcrumbs tittle="Privacy Policy" />
